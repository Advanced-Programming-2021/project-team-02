...
/*
davood comented codes to be deleted :
_______________________________________________________________________________________________________________________________________
-in spell switch case :
 private void normalSpellActivate(SpellEffect spellEffect) {
        switch (spellEffect) {
            case MONSTER_REBORN_EFFECT:
                monsterRebornSpell();
...
//        }
//    }
3-//    public void swordsOfRevealingLightSpell() {
//    }
4-
...
erfan commented codes to be deleted :
_______________________________________________________________________________________________________________________________________
1-//case SOLEMN_WARNING_EFFECT:
            //    solemnWarningTrapEffect();
            //    return true;
2-//    private void solemnWarningTrapEffect() {
//        getCurrentPlayer().decreaseLP(2000);
//        addCardToGraveYard(Zone.MONSTER_ZONE, selectedCellAddress, getCurrentPlayer());
//        deselectCard(0);
//    }

3-//    private void callOfTheHauntedTrapEffect() {
...
//        }
//    }
4-//case CALL_OF_THE_HAUNTED_EFFECT:
            //    callOfTheHauntedTrapEffect();
            //    return;
5-//    public void timeSealTrap() {
//
//    }
