...
public class Regex {
    ...
    static {
        ...
        DECK_ADD_CARD_TO_MAIN_DECK.add ("^deck add-card --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?)$");
        DECK_ADD_CARD_TO_MAIN_DECK.add ("^deck add-card --deck (?<cardName>[A-Za-z ',-]+) --card (?<cardName>[A-Za-z ',-]+)$");
        DECK_ADD_CARD_TO_SIDE_DECK = new ArrayList<> ();
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?) --side$");
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --deck (?<deckName>.+?) --card (?<cardName>[A-Za-z ',-]+) --side$");
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --side --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?)$");
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --side --deck (?<deckName>.+?) --card (?<cardName>[A-Za-z ',-]+)$");
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --card (?<cardName>[A-Za-z ',-]+) --side --deck (?<deckName>.+?)$");
        DECK_ADD_CARD_TO_SIDE_DECK.add ("^deck add-card --deck (?<deckName>.+?) --side --card (?<cardName>[A-Za-z ',-]+)$");
        DECK_REMOVE_CARD_MAIN_DECK = new ArrayList<> ();
        DECK_REMOVE_CARD_MAIN_DECK.add ("deck rm-card --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?)$");
        DECK_REMOVE_CARD_MAIN_DECK.add ("deck rm-card --deck (?<deckName>.+?) --card (?<cardName>[A-Za-z ',-]+)$");
        DECK_REMOVE_CARD_SIDE_DECK = new ArrayList<> ();
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?) --side$");
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --deck (?<deckName>.+?) --card (?<cardName>[A-Za-z ',-]+)$ --side");
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --card (?<cardName>[A-Za-z ',-]+) --side --deck (?<deckName>.+?)$");
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --deck (?<deckName>.+?) --side --card (?<cardName>[A-Za-z ',-]+)$");
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --side --card (?<cardName>[A-Za-z ',-]+) --deck (?<deckName>.+?)$");
        DECK_REMOVE_CARD_SIDE_DECK.add ("deck rm-card --side --deck (?<deckName>.+?) --card (?<cardName>[A-Za-z ',-]+)$");
