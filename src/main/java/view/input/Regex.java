...
public class Regex {
    ...
    public static final String CHEAT_DUEL_SET_WINNER = "^duel set-winner (?<winnerNickName>.+?)$";
    public static final String IMPORT_CARD = "^import card (?<cardName>.+?)$";
    public static final String EXPORT_CARD = "^export card (?<cardName>.+?)$";
