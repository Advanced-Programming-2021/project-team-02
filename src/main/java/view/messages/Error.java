...
public enum Error {
    ...
    CARD_DOES_NOT_EXIST_IN_MAIN_DECK("card with name <card name> does not exist in main deck"),
    CARD_DOES_NOT_EXIST_IN_SIDE_DECK("card with name <card name> does not exist in side deck"),
